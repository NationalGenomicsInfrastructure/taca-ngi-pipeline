...
class TestFilesystem(unittest.TestCase):
    ...
    def test_gather_files(self):
        ...
        expected_sourcepath = 'tests/data/deliver_testset.tar.gz'
        expected_dest_path = 'tests/data/stage/deliver_testset.tar.gz'
    ...
    def test_parse_hash_file(self):
        hashfile = 'tests/data/deliver_testset.tar.gz.md5'
        got_dict = filesystem.parse_hash_file(hashfile, '2020-12-07', root_path='tests/data')
